...
public class AwsGenerator {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        List<AWS.PrefixIpv4> awsIpv4Prefixes = aws.prefixes().stream()
                ...
                .values()
                .stream()
                .sorted(Comparator.comparing(AWS.PrefixIpv4::ip_prefix, IPAddressComparator.INSTANCE))
                .toList();
        ...
        List<AWS.PrefixIpv6> awsIpv6Prefixes = aws.ipv6_prefixes().stream()
                ...
                .values()
                .stream()
                .sorted(Comparator.comparing(AWS.PrefixIpv6::ipv6_prefix, IPAddressComparator.INSTANCE))
                .toList();
