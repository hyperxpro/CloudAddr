...
public class GCPGenerator {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        List<GCP.Prefix> ipv4Prefixes = gcp.prefixes().stream()
                ...
                .values()
                .stream()
                .sorted(Comparator.comparing(GCP.Prefix::ipv4Prefix, IPAddressComparator.INSTANCE))
                .toList();
        ...
        List<GCP.Prefix> ipv6Prefixes = gcp.prefixes().stream()
                ...
                .values()
                .stream()
                .sorted(Comparator.comparing(GCP.Prefix::ipv6Prefix, IPAddressComparator.INSTANCE))
                .toList();
